...
public class RelevanciaConsequenciaResponseDTO {
    ...
    public RelevanciaConsequenciaResponseDTO(String consequenciaUri, String consequenciaNome,
                                             String consequenciaDescricao, Frequencia frequencia, Impacto impacto,
